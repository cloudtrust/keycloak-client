...
func (c *Client) GetAuthenticatorProviders(accessToken string, realmName string) ([]map[string]any, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/authenticator-providers"), url.Param("realm", realmName))
	return resp, err
}
...
func (c *Client) GetClientAuthenticatorProviders(accessToken string, realmName string) ([]map[string]any, error) {
	var resp = []map[string]any{}
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/client-authenticator-providers"), url.Param("realm", realmName))
	return resp, err
}
...
func (c *Client) GetAuthenticatorProviderConfig(accessToken string, realmName, providerID string) (keycloak.AuthenticatorConfigInfoRepresentation, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/config-description/:providerID"), url.Param("realm", realmName), url.Param("providerID", providerID))
	return resp, err
}
...
func (c *Client) GetAuthenticatorConfig(accessToken string, realmName, configID string) (keycloak.AuthenticatorConfigRepresentation, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationConfigPath), url.Param("realm", realmName), url.Param("id", configID))
	return resp, err
}
...
func (c *Client) UpdateAuthenticatorConfig(accessToken string, realmName, configID string, config keycloak.AuthenticatorConfigRepresentation) error {
	return c.put(accessToken, url.Path(kcAuthenticationConfigPath), url.Param("realm", realmName), url.Param("id", configID), body.JSON(config))
}
...
func (c *Client) DeleteAuthenticatorConfig(accessToken string, realmName, configID string) error {
	return c.delete(accessToken, url.Path(kcAuthenticationConfigPath), url.Param("realm", realmName), url.Param("id", configID))
}
...
func (c *Client) CreateAuthenticationExecution(accessToken string, realmName string, authExec keycloak.AuthenticationExecutionRepresentation) (string, error) {
	return c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/executions"), url.Param("realm", realmName), body.JSON(authExec))
}
...
func (c *Client) DeleteAuthenticationExecution(accessToken string, realmName, executionID string) error {
	return c.delete(accessToken, url.Path(kcAuthenticationManagementPath+"/executions/:id"), url.Param("realm", realmName), url.Param("id", executionID))
}
...
func (c *Client) UpdateAuthenticationExecution(accessToken string, realmName, executionID string, authConfig keycloak.AuthenticatorConfigRepresentation) error {
	_, err := c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/executions/:id/config"), url.Param("realm", realmName), url.Param("id", executionID), body.JSON(authConfig))
	return err
}
...
func (c *Client) LowerExecutionPriority(accessToken string, realmName, executionID string) error {
	_, err := c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/executions/:id/lower-priority"), url.Param("realm", realmName), url.Param("id", executionID))
	return err
}
...
func (c *Client) RaiseExecutionPriority(accessToken string, realmName, executionID string) error {
	_, err := c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/executions/:id/raise-priority"), url.Param("realm", realmName), url.Param("id", executionID))
	return err
}
...
func (c *Client) CreateAuthenticationFlow(accessToken string, realmName string, authFlow keycloak.AuthenticationFlowRepresentation) error {
	_, err := c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/flows"), url.Param("realm", realmName), body.JSON(authFlow))
	return err
}
...
func (c *Client) GetAuthenticationFlows(accessToken string, realmName string) ([]keycloak.AuthenticationFlowRepresentation, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/flows"), url.Param("realm", realmName))
	return resp, err
}
...
func (c *Client) CopyExistingAuthenticationFlow(accessToken string, realmName, flowAlias, newName string) error {
	...
	_, err := c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/flows/:flowAlias/copy"), url.Param("realm", realmName), url.Param("flowAlias", flowAlias), body.JSON(m))
	return err
}
...
func (c *Client) GetAuthenticationExecutionForFlow(accessToken string, realmName, flowAlias string) (keycloak.AuthenticationExecutionInfoRepresentation, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/flows/:flowAlias/executions"), url.Param("realm", realmName), url.Param("flowAlias", flowAlias))
	return resp, err
}
...
func (c *Client) UpdateAuthenticationExecutionForFlow(accessToken string, realmName, flowAlias string, authExecInfo keycloak.AuthenticationExecutionInfoRepresentation) error {
	return c.put(accessToken, url.Path(kcAuthenticationManagementPath+"/flows/:flowAlias/executions"), url.Param("realm", realmName), url.Param("flowAlias", flowAlias), body.JSON(authExecInfo))
}
...
func (c *Client) CreateAuthenticationExecutionForFlow(accessToken string, realmName, flowAlias, provider string) (string, error) {
	...
	return c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/flows/:flowAlias/executions/execution"), url.Param("realm", realmName), url.Param("flowAlias", flowAlias), body.JSON(m))
}
...
func (c *Client) CreateFlowWithExecutionForExistingFlow(accessToken string, realmName, flowAlias, alias, flowType, provider, description string) (string, error) {
	...
	return c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/flows/:flowAlias/executions/flow"), url.Param("realm", realmName), url.Param("flowAlias", flowAlias), body.JSON(m))
}
...
func (c *Client) GetAuthenticationFlow(accessToken string, realmName, flowID string) (keycloak.AuthenticationFlowRepresentation, error) {
	var resp = keycloak.AuthenticationFlowRepresentation{}
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/flows/:id"), url.Param("realm", realmName), url.Param("id", flowID))
	return resp, err
}
...
func (c *Client) DeleteAuthenticationFlow(accessToken string, realmName, flowID string) error {
	return c.delete(accessToken, url.Path(kcAuthenticationManagementPath+"/flows/:id"), url.Param("realm", realmName), url.Param("id", flowID))
}
...
func (c *Client) GetFormActionProviders(accessToken string, realmName string) ([]map[string]any, error) {
	var resp = []map[string]any{}
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/form-action-providers"), url.Param("realm", realmName))
	return resp, err
}
...
func (c *Client) GetFormProviders(accessToken string, realmName string) ([]map[string]any, error) {
	var resp = []map[string]any{}
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/form-providers"), url.Param("realm", realmName))
	return resp, err
}
...
func (c *Client) GetConfigDescriptionForClients(accessToken string, realmName string) (map[string]any, error) {
	var resp = map[string]any{}
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/per-client-config-description"), url.Param("realm", realmName))
	return resp, err
}
...
func (c *Client) RegisterRequiredAction(accessToken string, realmName, providerID, name string) error {
	...
	_, err := c.post(accessToken, nil, url.Path(kcAuthenticationManagementPath+"/register-required-action"), url.Param("realm", realmName), body.JSON(m))
	return err
}
...
func (c *Client) GetRequiredActions(accessToken string, realmName string) ([]keycloak.RequiredActionProviderRepresentation, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationRequiredActionsPath), url.Param("realm", realmName))
	return resp, err
}
...
func (c *Client) GetRequiredAction(accessToken string, realmName, actionAlias string) (keycloak.RequiredActionProviderRepresentation, error) {
	var resp = keycloak.RequiredActionProviderRepresentation{}
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationRequiredActionPath), url.Param("realm", realmName), url.Param("alias", actionAlias))
	return resp, err
}
...
func (c *Client) UpdateRequiredAction(accessToken string, realmName, actionAlias string, action keycloak.RequiredActionProviderRepresentation) error {
	return c.put(accessToken, url.Path(kcAuthenticationRequiredActionPath), url.Param("realm", realmName), url.Param("alias", actionAlias), body.JSON(action))
}
...
func (c *Client) DeleteRequiredAction(accessToken string, realmName, actionAlias string) error {
	return c.delete(accessToken, url.Path(kcAuthenticationRequiredActionPath), url.Param("realm", realmName), url.Param("alias", actionAlias))
}
...
func (c *Client) GetUnregisteredRequiredActions(accessToken string, realmName string) ([]map[string]any, error) {
	var resp = []map[string]any{}
	var err = c.get(accessToken, &resp, url.Path(kcAuthenticationManagementPath+"/unregistered-required-actions"), url.Param("realm", realmName))
	return resp, err
}

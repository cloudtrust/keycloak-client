...
const (
	...
	ctAccountLinkedAccountsPath         = "/auth/realms/:realm/account/linked-accounts"
	ctAccountLinkedAccountsProviderPath = ctAccountLinkedAccountsPath + "/:providerAlias"
...
func (c *AccountClient) GetCredentials(accessToken string, realmName string) ([]keycloak.CredentialRepresentation, error) {
	...
	var err = c.client.forRealm(accessToken, realmName).
		get(accessToken, &resp, url.Path(ctAccountCredentialsPath), url.Param("realm", realmName), hdrAcceptJSON)
	return resp, err
}
...
func (c *AccountClient) GetCredentialRegistrators(accessToken string, realmName string) ([]string, error) {
	var resp = []string{}
	var err = c.client.forRealm(accessToken, realmName).
		get(accessToken, &resp, url.Path(ctAccountCredentialsRegistratorsPath), url.Param("realm", realmName), hdrAcceptJSON)
	return resp, err
}
...
func (c *AccountClient) UpdateLabelCredential(accessToken string, realmName string, credentialID string, label string) error {
	return c.client.forRealm(accessToken, realmName).
		put(accessToken, url.Path(ctAccountCredentialLabelPath), url.Param("realm", realmName), url.Param("credentialID", credentialID), body.String(label), hdrAcceptJSON, hdrContentTypeTextPlain)
}
...
func (c *AccountClient) DeleteCredential(accessToken string, realmName string, credentialID string) error {
	return c.client.forRealm(accessToken, realmName).
		delete(accessToken, url.Path(ctAccountCredentialIDPath), url.Param("realm", realmName), url.Param("credentialID", credentialID), hdrAcceptJSON)
}
...
func (c *AccountClient) MoveToFirst(accessToken string, realmName string, credentialID string) error {
	_, err := c.client.forRealm(accessToken, realmName).
		post(accessToken, nil, url.Path(ctAccountMoveFirstPath), url.Param("realm", realmName), url.Param("credentialID", credentialID), hdrAcceptJSON)
	return err
}
...
func (c *AccountClient) MoveAfter(accessToken string, realmName string, credentialID string, previousCredentialID string) error {
	_, err := c.client.forRealm(accessToken, realmName).
		post(accessToken, nil, url.Path(ctAccountMoveAfterPath), url.Param("realm", realmName), url.Param("credentialID", credentialID), url.Param("previousCredentialID", previousCredentialID), hdrAcceptJSON)
	return err
}

// UpdatePassword updates the user's password
// Parameters: realm, currentPassword, newPassword, confirmPassword
func (c *AccountClient) UpdatePassword(accessToken, realmName, currentPassword, newPassword, confirmPassword string) (string, error) {
...
func (c *AccountClient) GetAccount(accessToken string, realmName string) (keycloak.UserRepresentation, error) {
	var resp = keycloak.UserRepresentation{}
	var err = c.client.forRealm(accessToken, realmName).
		get(accessToken, &resp, url.Path(ctAccountExtensionAPIPath), url.Param("realm", realmName), hdrAcceptJSON)
	return resp, err
}

// UpdateAccount updates the user's information
func (c *AccountClient) UpdateAccount(accessToken string, realmName string, user keycloak.UserRepresentation) error {
	_, err := c.client.forRealm(accessToken, realmName).
		post(accessToken, nil, url.Path(ctAccountExtensionAPIPath), url.Param("realm", realmName), body.JSON(user))
	return err
}
...
func (c *AccountClient) DeleteAccount(accessToken string, realmName string) error {
	return c.client.forRealm(accessToken, realmName).
		delete(accessToken, url.Path(ctAccountExtensionAPIPath), url.Param("realm", realmName), hdrAcceptJSON)
}
...
func (c *AccountClient) ExecuteActionsEmail(accessToken string, realmName string, actions []string) error {
	return c.client.forRealm(accessToken, realmName).
		put(accessToken, url.Path(ctAccountExecuteActionsEmail), url.Param("realm", realmName), body.JSON(actions))
}
...
func (c *AccountClient) GetLinkedAccounts(accessToken string, realmName string) ([]keycloak.LinkedAccountRepresentation, error) {
	...
	var err = c.client.forRealm(accessToken, realmName).
		get(accessToken, &resp, url.Path(ctAccountLinkedAccountsPath), url.Param("realm", realmName), hdrAcceptJSON)
	return resp, err
}
...
func (c *AccountClient) DeleteLinkedAccount(accessToken string, realmName string, providerAlias string) error {
	return c.client.forRealm(accessToken, realmName).
		delete(accessToken, url.Path(ctAccountLinkedAccountsProviderPath), url.Param("realm", realmName), url.Param("providerAlias", providerAlias), hdrAcceptJSON)
}

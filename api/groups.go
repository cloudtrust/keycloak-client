...
func (c *Client) GetGroups(accessToken string, realmName string) ([]keycloak.GroupRepresentation, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcGroupsPath), url.Param("realm", realmName))
	return resp, err
}
...
func (c *Client) GetGroup(accessToken string, realmName string, groupID string) (keycloak.GroupRepresentation, error) {
	var resp = keycloak.GroupRepresentation{}
	var err = c.get(accessToken, &resp, url.Path(kcGroupByIDPath), url.Param("realm", realmName), url.Param("id", groupID))
	return resp, err
}
...
func (c *Client) CreateGroup(accessToken string, reqRealmName string, group keycloak.GroupRepresentation) (string, error) {
	return c.post(accessToken, nil, url.Path(kcGroupsPath), url.Param("realm", reqRealmName), body.JSON(group))
}
...
func (c *Client) DeleteGroup(accessToken string, realmName string, groupID string) error {
	return c.delete(accessToken, url.Path(kcGroupByIDPath), url.Param("realm", realmName), url.Param("id", groupID))
}
...
func (c *Client) AssignClientRole(accessToken string, realmName string, groupID string, clientID string, roles []keycloak.RoleRepresentation) error {
	_, err := c.post(accessToken, nil, url.Path(kcGroupClientRoleMappingPath), url.Param("realm", realmName), url.Param("id", groupID), url.Param("clientId", clientID), body.JSON(roles))
	return err
}
...
func (c *Client) RemoveClientRole(accessToken string, realmName string, groupID string, clientID string, roles []keycloak.RoleRepresentation) error {
	return c.delete(accessToken, url.Path(kcGroupClientRoleMappingPath), url.Param("realm", realmName), url.Param("id", groupID), url.Param("clientId", clientID), body.JSON(roles))
}
...
func (c *Client) GetGroupClientRoles(accessToken string, realmName string, groupID string, clientID string) ([]keycloak.RoleRepresentation, error) {
	...
	var err = c.get(accessToken, &roles, url.Path(kcGroupClientRoleMappingPath), url.Param("realm", realmName), url.Param("id", groupID), url.Param("clientId", clientID))
	return roles, err
}
...
func (c *Client) GetAvailableGroupClientRoles(accessToken string, realmName string, groupID string, clientID string) ([]keycloak.RoleRepresentation, error) {
	var roles = []keycloak.RoleRepresentation{}
	var err = c.get(accessToken, &roles, url.Path(kcAvailableGroupClientRoleMappingPath), url.Param("realm", realmName), url.Param("id", groupID), url.Param("clientId", clientID))
	return roles, err
}

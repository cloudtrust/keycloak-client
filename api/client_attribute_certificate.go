...
func (c *Client) GetKeyInfo(accessToken string, realmName, idClient, attr string) (keycloak.CertificateRepresentation, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcClientAttrCertPath), url.Param("realm", realmName), url.Param("id", idClient), url.Param("attr", attr))
	return resp, err
}
...
func (c *Client) GetKeyStore(accessToken string, realmName, idClient, attr string, keyStoreConfig keycloak.KeyStoreConfig) ([]byte, error) {
	var resp = []byte{}
	_, err := c.post(accessToken, &resp, url.Path(kcClientAttrCertPath+"/download"), url.Param("realm", realmName), url.Param("id", idClient), url.Param("attr", attr), body.JSON(keyStoreConfig))
	return resp, err
}
...
func (c *Client) GenerateCertificate(accessToken string, realmName, idClient, attr string) (keycloak.CertificateRepresentation, error) {
	var resp = keycloak.CertificateRepresentation{}
	_, err := c.post(accessToken, &resp, url.Path(kcClientAttrCertPath+"/generate"), url.Param("realm", realmName), url.Param("id", idClient), url.Param("attr", attr))
	return resp, err
}
...
func (c *Client) GenerateKeyPairAndCertificate(accessToken string, realmName, idClient, attr string, keyStoreConfig keycloak.KeyStoreConfig) ([]byte, error) {
	var resp = []byte{}
	_, err := c.post(accessToken, &resp, url.Path(kcClientAttrCertPath+"/generate-and-download"), url.Param("realm", realmName), url.Param("id", idClient), url.Param("attr", attr), body.JSON(keyStoreConfig))
	return resp, err
}
...
func (c *Client) UploadCertificatePrivateKey(accessToken string, realmName, idClient, attr string, file []byte) (keycloak.CertificateRepresentation, error) {
	var resp = keycloak.CertificateRepresentation{}
	_, err := c.post(accessToken, &resp, url.Path(kcClientAttrCertPath+"/upload"), url.Param("realm", realmName), url.Param("id", idClient), url.Param("attr", attr), body.Reader(bytes.NewReader(file)))
	return resp, err
}
...
func (c *Client) UploadCertificate(accessToken string, realmName, idClient, attr string, file []byte) (keycloak.CertificateRepresentation, error) {
	var resp = keycloak.CertificateRepresentation{}
	_, err := c.post(accessToken, &resp, url.Path(kcClientAttrCertPath+"/upload-certificate"), url.Param("realm", realmName), url.Param("id", idClient), url.Param("attr", attr), body.Reader(bytes.NewReader(file)))
	return resp, err
}

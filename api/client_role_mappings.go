...
func (c *Client) AddClientRolesToUserRoleMapping(accessToken string, realmName, userID, clientID string, roles []keycloak.RoleRepresentation) error {
	_, err := c.post(accessToken, nil, url.Path(kcClientRoleMappingPath), url.Param("realm", realmName), url.Param("id", userID), url.Param("client", clientID), body.JSON(roles))
	return err
}
...
func (c *Client) GetClientRoleMappings(accessToken string, realmName, userID, clientID string) ([]keycloak.RoleRepresentation, error) {
	...
	var err = c.get(accessToken, &resp, url.Path(kcClientRoleMappingPath), url.Param("realm", realmName), url.Param("id", userID), url.Param("client", clientID))
	return resp, err
}
...
func (c *Client) DeleteClientRolesFromUserRoleMapping(accessToken string, realmName, userID, clientID string, roles []keycloak.RoleRepresentation) error {
	return c.delete(accessToken, url.Path(kcClientRoleMappingPath), url.Param("realm", realmName), url.Param("id", userID), url.Param("client", clientID), body.JSON(roles))
}
...
func (c *Client) GetRealmLevelRoleMappings(accessToken string, realmName, userID string) ([]keycloak.RoleRepresentation, error) {
	var resp = []keycloak.RoleRepresentation{}
	var err = c.get(accessToken, &resp, url.Path(kcRealmRoleMappingPath), url.Param("realm", realmName), url.Param("id", userID))
	return resp, err
}
...
func (c *Client) AddRealmLevelRoleMappings(accessToken string, realmName, userID string, roles []keycloak.RoleRepresentation) error {
	var _, err = c.post(accessToken, nil, url.Path(kcRealmRoleMappingPath), url.Param("realm", realmName), url.Param("id", userID), body.JSON(roles))
	return err
}
...
func (c *Client) DeleteRealmLevelRoleMappings(accessToken string, realmName, userID string, roles []keycloak.RoleRepresentation) error {
	return c.delete(accessToken, url.Path(kcRealmRoleMappingPath), url.Param("realm", realmName), url.Param("id", userID), body.JSON(roles))
}
